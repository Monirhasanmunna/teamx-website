        ...
        <section id="GeneralSettings">
            ...
            <div class="card col-lg-6 m-auto">
                ...
                <form action="{{ route('faq.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="old_photo" value="{{ $faq->photo }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title" placeholder="Header" value="{{ $faq->title }}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description" placeholder="description" rows="5">{{ $faq->description }}</textarea>
                                </div>
                            </div>
